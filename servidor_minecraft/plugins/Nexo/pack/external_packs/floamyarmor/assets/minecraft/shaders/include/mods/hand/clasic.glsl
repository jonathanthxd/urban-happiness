    ...
    case FIRST_PERSON_RIGHT_HAND:{
                ADD_BOX_WITH_ROTATION_ROTATE_NO_TRANSPARENCY(vec3(1.5,0,-4), vec3(2,5,2),
                    PIY12, vec3(0, 0, 0),
                ...
                ADD_BOX_WITH_ROTATION_ROTATE(vec3(1.5,0,-4), vec3(1.75,5.25,2.25),
                    PIY12, vec3(0, 0, 0),
    ...
    case FIRST_PERSON_RIGHT_HAND_SLIM:{
                ADD_BOX_WITH_ROTATION_ROTATE_NO_TRANSPARENCY(vec3(1.5,0,-4), vec3(1.5,5,2),
                    PIY2, vec3(0, 0, 0),
...
#ifdef VSH
        if (getChannel(ivec2(1,0),0) == 128.0 &&
            getChannel(ivec2(1,0),2) == 128.0) 
        {
